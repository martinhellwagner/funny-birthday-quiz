    ...
    <transition name="transition" mode="out-in">
      <div :key="questionIndex">
        ...
        <div class="buttons">
          ...
          <router-link :to="{ name: 'questions' }"><button class="button button--red button--moveAwayRight" v-if="questionIndex == numberOfQuestions">Please kill me now.</button></router-link>
        </div>
      </div>
    </transition>
